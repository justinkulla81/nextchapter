...
export const metadata: Metadata = {
  ...
  description:
    'See how candidates actually work before the first call — verified profiles and How They Work Best insight, at one flat monthly price with no per-hire fees. Join the employer waitlist.',
  alternates: { canonical: '/employers' },
  openGraph: {
    title: 'Hire for Fit, Not Keywords — NextChapter for Employers',
    description:
      'See how candidates actually work before the first call — verified profiles and How They Work Best insight, at one flat monthly price with no per-hire fees.',
