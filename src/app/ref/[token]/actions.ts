...
export async function submitReference(_prevState: FormState, formData: FormData): Promise<FormState> {
  ...
  const updatedReference = await prisma.reference.update({
    ...
    data: {
      ...
      verifiedCompanyCorrect: extension.verifiedCompanyCorrect,
      correctedCompany: extension.correctedCompany,
      verifiedBulletCorrect: extension.verifiedBulletCorrect,
      correctedBullet: extension.correctedBullet,
