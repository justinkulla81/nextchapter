    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-8 space-y-8 text-base leading-relaxed text-foreground">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>To generate your Market Reality Grade, Search Action Grade, personalized action plan, resume feedback, and job-fit analysis.</li>
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            your Market Reality Grade and Search Action Grade narratives, action plan, and job-fit
        ...
        <section className="space-y-3">
          ...
          <p>
            Your Market Reality Grade, Search Action Grade, action plan, and any AI-generated feedback are provided for
