    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-8 space-y-8 text-base leading-relaxed text-foreground">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>To generate your Hireability Grade, personalized action plan, resume feedback, and job-fit analysis.</li>
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            your Hireability Grade narrative, action plan, and job-fit feedback. Your resume text
        ...
        <section className="space-y-3">
          ...
          <p>
            Your Hireability Grade, action plan, and any AI-generated feedback are provided for
