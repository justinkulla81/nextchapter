...
import { deleteJobPosting, retryJobFetch, markInterviewLanded, markOfferReceived } from './actions'
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">
          Add up to 5 jobs you like and get honest feedback on how well you actually fit them.
        </p>
      </div>
