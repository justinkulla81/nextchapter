...
export const metadata: Metadata = {
  ...
  description:
    'Give your career, life, and executive coaching clients a free Market Reality Grade, action plan, and daily accountability between your sessions. Free, set up in under a minute.',
  alternates: { canonical: '/for-coaches' },
  openGraph: {
    title: 'Bring Your Clients Onto NextChapter — For Coaches',
    description:
      'Give your coaching clients a free Market Reality Grade, action plan, and daily accountability between your sessions.',
