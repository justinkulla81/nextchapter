...
// one-line signal of exactly what's blocking their A, without a wall of
// extra explanation the candidate already sees on their dashboard.
  ...
  return (
    <div className="rounded-lg border border-orange/30 bg-orange/5 p-4">
      <p className="text-sm font-medium text-foreground">
        Unlock {lockedCount} exclusive {opportunityWord} when you achieve a Market Reality Report A grade — you&apos;re
        currently a {grade}.
      </p>
    </div>
  )
