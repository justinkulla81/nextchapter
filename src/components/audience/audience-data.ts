...
export const AUDIENCE_TABS: AudienceTab[] = [
    ...
    points: [
      {
        ...
        body: 'Every participant gets a free Market Reality Grade, a personalized action plan, and direct matches to hiring employers — practical next steps, not a portal they log into once and abandon.',
      },
      {
  ...
  },
  {
    ...
    subhead:
      "You already know your clients' situations better than any assessment could. NextChapter gives them a free Market Reality Grade, a personalized action plan, and daily accountability between your sessions — while you keep the human relationship you already have.",
    points: [
      {
