import type { SituationKey } from './onboarding'
...
export const PERSONAS: Persona[] = [
  {
    ...
    body: [
      ...
      "Get your free Current Market Reality privately. Nothing about using NextChapter is visible to your employer, your team, or anyone in your network unless you choose to share it.",
    ],
  },
  {
    slug: 'laid-off',
    ...
    body: [
      ...
      'Get an honest Current Market Reality, a Weekly Search Score you can actually move, and a community of people going through the exact same thing right now.',
    ],
  },
  {
    slug: 'resigned',
