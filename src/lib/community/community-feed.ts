...
export type CommunityFeedItemType = 'activity' | 'comeback' | 'marketBrief'

export interface CommunityFeedItem {
  id: string
  type: CommunityFeedItemType
  displayName: string | null // null for marketBrief — not tied to a candidate
...
// Real, live-computed anonymized activity — every item here is a genuine
// event pulled from existing data, not synthesized or curated.
